...
RUN apt-get update && apt-get install -y openjdk-7-jdk curl wget supervisor unzip rsync git ssh python-software-properties software-properties-common && apt-get clean
